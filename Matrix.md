...
- Le fait que le produit de 2 matrices donne la matrice nulle **NE SIGNIFIE PAS** que l'une des matrices est la matrice nulle (on ne peut pas faire d'analogie avec les rééls où quand on a ab=0, alors a=0 ou b=0). Il y a masse contres-exemples de situations où 2 matrices non nulles qu'on multiplie entre elles donne une matrice nulle.
