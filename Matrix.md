...
<img src="https://latex.codecogs.com/gif.latex?\text{Une}\%20\text{matrice}\%20\text{est}\%20\text{un}\%20\text{tableau}\%20\text{rectangulaire}\%20\text{de}\%20n_{\in\mathbb{N}^{\ast}}\%20\text{lignes}\%20\text{sur}\%20\text{p}_{\in\mathbb{N}^{\ast}}\text{contenant}\%20\text{des}\%20\text{elements}\%20\text{de}\%20\text{K}" />
